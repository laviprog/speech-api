...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "status",
            sa.Enum(
                "PENDING", "IN_PROGRESS", "COMPLETED", "FAILED", "CANCELED", name="task_status"
            ),
            nullable=False,
        ),
        ...
        sa.Column(
            "model",
            sa.Enum("SMALL", "TURBO", "LARGE_V3_TURBO", name="transcription_model"),
            nullable=False,
        ),
        ...
        sa.Column(
            "started_at", advanced_alchemy.types.datetime.DateTimeUTC(timezone=True), nullable=True
        ),
        sa.Column(
            "completed_at",
            advanced_alchemy.types.datetime.DateTimeUTC(timezone=True),
        ...
        sa.ForeignKeyConstraint(
            ["api_key_id"], ["api_keys.id"], name=op.f("fk_transcription_tasks_api_key_id_api_keys")
        ),
